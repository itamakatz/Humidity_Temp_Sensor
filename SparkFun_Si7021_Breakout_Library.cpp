...
{
  return((readTempC() * 1.8) + 32.0); // Convert celsius to fahrenheit
}

float Weather::getTempF()
{
  return((getTempC() * 1.8) + 32.0); // Convert celsius to fahrenheit
}
